...
namespace JCS
{
    ...
    public class ToggleSwitch : Control
    {
        ...
        public new Color ForeColor
        {
            ...
            set { base.ForeColor = Color.Black; } //-V3077
        }
        ...
        public new Font Font
        {
            ...
            set { base.Font = new Font(base.Font, FontStyle.Regular); } //-V3077
        }
        ...
        private void                    raiseRightMouseDown(MouseEventArgs e)
        {
        ...
        {
            if (_animating || !AllowUserChange || e.Button == MouseButtons.Right)
                return;
        ...
        private void AnimationComplete()
        {
            ...
            var lCheckedChanged = CheckedChanged;
            if (lCheckedChanged != null)
                lCheckedChanged(this, new EventArgs());
