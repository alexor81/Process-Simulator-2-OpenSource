...
{
    public class SymbolEllipse: ISymbol
    {
        ...
        public Bitmap               draw(int aWidth, int aHeight)
        {
            ...
            using (var lGraphics = Graphics.FromImage(lResult))
            {
                ...
                if (mFillColor.A > 0)
                {
                    lGraphics.FillEllipse(mFillBrush, lBorderDiv2, lBorderDiv2, lW, lH);
                }

                if (mBorderWidth != 0)
                {
                    lGraphics.DrawEllipse(mBorderPen, lBorderDiv2, lBorderDiv2, lW, lH);
                }
            }
